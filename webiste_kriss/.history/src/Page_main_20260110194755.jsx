...
const proyectos = [
  {
    ...
    descripcion:
      "Proyecto para la gestion hospitalaria full-stack. Incluye autenticacion JWT, sistema automatizado de tickets y actualizacion en tiempo real de la base de datos.",
    videoId: "jvm6DpqqbLk", // Solo el ID del video
    links: [
      { label: "Github", url: "https://github.com/CristianJ23/prototipo_clinicaHospital_SanJose" },
