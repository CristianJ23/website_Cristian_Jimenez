...
const misProyectos = [
  {
    titulo: "Medical Admin Full-Stack",
    descripcion: "Sistema completo con Spring Boot y React. Maneja autenticación JWT y base de datos relacional.",
    videoId: "dQw4w9WgXcQ", // Reemplaza con tu ID real
    tags: ["Java", "Spring", "React"],
    links: [
      { label: "Backend Repo", url: "https://github.com/..." },
      { label: "Frontend Repo", url: "https://github.com/..." }
    ]
  }
];
