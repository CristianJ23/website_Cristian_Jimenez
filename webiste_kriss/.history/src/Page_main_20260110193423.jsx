...
const proyectos = [
  ...
  // },
  {
    ...
    imagen: "https://www.youtube.com/watch?v=jvm6DpqqbLk&list=PLwR1545A9Prh_mbSLqAaE53R2hI_xzi3B&index=23",
    links: [
...
//         <span
//           key={tag}
//           className="text-[10px] font-bold px-2 py-0.5 bg-indigo-50 text-indigo-600 rounded-md uppercase"
//         >
//           {tag}
//         </span>
//       ))}
      ...
      <main className="max-w-4xl mx-auto px-4 pb-16">
        ...
        <section id="proyectos" className="pt-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <CardProyectoVideo></CardProyectoVideo>
