...
const datosCursos = [
  { 
    nombre: 'Becario Workshop Internacional Phawai + Tarecda: Investigación en inteligencia artificial', 
    emisor: 'Coursera', 
    anio: 2024,
    link: 'https://www.coursera.org/account/accomplishments/verify/TU_ID',
    imagen: 'https://upload.wikimedia.org/wikipedia/commons/9/97/Coursera-logo_v2.svg' // Logo o captura
  },
  // ... agrega los demás
];
