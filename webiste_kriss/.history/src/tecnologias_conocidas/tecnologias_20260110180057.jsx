...
const Tecnologias = () => {
  ...
  const categories = ['alls', ...Object.keys(techData)];

  // Aplanar alls los logos para el carrusel
  ...
  return (
    <section id="tecnologias" className="py-20 bg-gray-50/50">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <p className="text-center text-gray-600 mb-12">Explore the tools I use to bring my projects to life.</p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
          {Object.entries(techData).map(([cat, techs]) => (
            // Solo mostrar si es la categoría activa o si está en "alls"
            (activeTab === 'alls' || activeTab === cat) && techs.map((tech, i) => (
              <div 
                key={`${cat}-${i}`}
