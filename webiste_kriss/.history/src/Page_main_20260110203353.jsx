      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div className="relative z-20 w-14 h-14">
            <div className="w-44 h-14 bg-white rounded-xl flex items-center justify-center flex-shrink-0 border border-indigo-50 shadow-sm transition-all duration-500 ease-in-out group-hover:scale-[5] group-hover:shadow-2xl group-hover:z-50 origin-center bg-white">
              <img
                src={curso.imagen}
                alt={curso.nombre}
